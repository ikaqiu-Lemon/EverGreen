...
const (
	...
	//   block_boundary_materialization（当期）：2026-09-22-storage-v3-contract-decisions.md
	//     —— Storage v3 的版本号与发布口径唯一决策出处，逐字声明当期版本号并对推送 / tag 标「未知」。
	// 只把当期指针往前挪属**阶段化更新**，不放宽任何断言：M2/M3/M4/M5/M6 各份历史文档仍在盘、事实一字未改。
	docsReleaseSpec = "../../../teamwork/projects/evergreen/block_boundary_materialization/docs/specs/2026-09-22-storage-v3-contract-decisions.md"
)
